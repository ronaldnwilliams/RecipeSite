    ...
    public void run(ApplicationArguments args) {
        ...
        try {
            recipe1 = new Recipe(
                    ...
                    Category.DINNER,
                    Files.readAllBytes(Paths.get("/Users/ronaldwilliams/Programming/IdeaProjects/Java/recipesite/src/main/resources/static/assets/images/salmon.jpg")),
                    "30",
                    "30",
                    steps,
        ...
        try {
            recipe2 = new Recipe(
                    ...
                    Category.DESSERT,
                    Files.readAllBytes(Paths.get("/Users/ronaldwilliams/Programming/IdeaProjects/Java/recipesite/src/main/resources/static/assets/images/frenchtoast.jpg")),
                    "15",
                    "15",
                    steps,
                    ingredientDao.findAll().subList(0,2),
        ...
        try {
            recipe3 = new Recipe(
                    ...
                    Category.LUNCH,
                    Files.readAllBytes(Paths.get("/Users/ronaldwilliams/Programming/IdeaProjects/Java/recipesite/src/main/resources/static/assets/images/miso.jpg")),
                    "25",
                    "25",
                    steps,
                    ingredientDao.findAll().subList(0,2),
        ...
        try {
            recipe4 = new Recipe(
                    ...
                    Category.DINNER,
                    Files.readAllBytes(Paths.get("/Users/ronaldwilliams/Programming/IdeaProjects/Java/recipesite/src/main/resources/static/assets/images/chicken.jpg")),
                    "35",
                    "40",
                    steps,
